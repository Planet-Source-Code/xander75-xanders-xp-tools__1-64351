VERSION 5.00
Begin VB.UserControl XandersXPProgressBar 
   ClientHeight    =   495
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   3315
   ScaleHeight     =   495
   ScaleWidth      =   3315
   ToolboxBitmap   =   "XandersXPProgressBar.ctx":0000
   ...
   End
End
Attribute VB_Name = "XandersXPProgressBar"
...
Public Property Let AutoScroll(ByVal New_AutoScroll As Boolean)
    m_AutoScroll = New_AutoScroll
    PropertyChanged "AutoScroll"
    If m_AutoScroll = True Then
        tmrAutoScroll.Enabled = True
    ElseIf m_AutoScroll = False Then
